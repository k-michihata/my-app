...
// @ts-ignore
import { Phone, Mail, MapPin, ChevronRight, Building2, HardHat, Users, FileText, Send, Home, Search, PenToolIcon as Tool, Package, Building, Key } from 'lucide-react'
// @ts-ignore
        ...
        <div className="container">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="mb-4 text-2xl font-bold flex items-center">
                  <Home className="mr-2 h-6 w-6 text-[#FF9B50]" />
                  家を建てる
                </h3>
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="mb-4 text-2xl font-bold flex items-center">
                  <Search className="mr-2 h-6 w-6 text-[#FF9B50]" />
                  土地探しのポイント
                </h3>
                <p className="text-muted-foreground">
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="mb-4 text-2xl font-bold flex items-center">
                  <Tool className="mr-2 h-6 w-6 text-[#FF9B50]" />
                  リフォームする
                </h3>
                <p className="text-muted-foreground">
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="mb-4 text-2xl font-bold flex items-center">
                  <Package className="mr-2 h-6 w-6 text-[#FF9B50]" />
                  収納
                </h3>
                <p className="text-muted-foreground">
                  空間を最大限に活用する収納プランニング。
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="mb-4 text-2xl font-bold flex items-center">
                  <Building className="mr-2 h-6 w-6 text-[#FF9B50]" />
                  アパート建設
                </h3>
                <p className="text-muted-foreground">
                  収益性と居住性を両立したアパート建設。
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="mb-4 text-2xl font-bold flex items-center">
                  <Key className="mr-2 h-6 w-6 text-[#FF9B50]" />
                  賃貸管理
                </h3>
                <p className="text-muted-foreground">
            ...
            <CardContent className="p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <HardHat className="h-6 w-6 text-[#FF9B50]" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Users className="h-6 w-6 text-[#FF9B50]" />
                  <div>
